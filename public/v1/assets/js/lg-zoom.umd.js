  ...
  function () {
    function Zoom(instance, $LG) {
      ...
      if (this.settings.zoom) {
        ...
        this.positionChanged = false; // Set the initial value center
    ...
    Zoom.prototype.zoomImage = function (scale) {
      ...
      if (!imageNode) return;
      var containerRect = this.core.outer.get().getBoundingClientRect(); // Find offset manually to avoid issue after zoom
    ...
    Zoom.prototype.setActualSize = function (index, event) {
      ...
      var currentItem = this.core.galleryItems[this.core.index]; // Allow zoom only on image
    ...
    Zoom.prototype.resetZoom = function (index) {
      ...
      $item.find('.lg-image').first().removeAttr('style data-scale'); // Reset pagx pagy values to center
    ...
    Zoom.prototype.zoomSwipe = function () {
      ...
      this.core.$inner.on('touchstart.lg', function (e) {
        e.preventDefault();
        var currentItem = _this.core.galleryItems[_this.core.index]; // Allow zoom only on image
        ...
        if ((_this.$LG(e.target).hasClass('lg-item') || $item.get().contains(e.target)) && e.targetTouches.length === 1 && _this.core.outer.hasClass('lg-zoomed')) {
          ...
          possibleSwipeCords = _this.getPossibleSwipeDragCords($image, rotateValue); // reset opacity and transition duration
    ...
    Zoom.prototype.zoomDrag = function () {
      ...
      var isMoved = false;
      var rotateEl = null;
      var rotateValue = 0; // Allow x direction drag
      ...
      this.core.outer.on('mousedown.lg.zoom', function (e) {
        ...
        if (_this.$LG(e.target).hasClass('lg-item') || $item.get().contains(e.target)) {
          startTime = new Date(); // execute only on .lg-object
          ...
          if (_this.core.outer.hasClass('lg-zoomed')) {
            if (_this.$LG(e.target).hasClass('lg-object') && (allowX || allowY)) {
              ...
              isDragging = true;
              dataY = parseFloat(_LGel.attr('data-y'));
              dataX = parseFloat(_LGel.attr('data-x')); // ** Fix for webkit cursor issue https://code.google.com/p/chromium/issues/detail?id=26723
