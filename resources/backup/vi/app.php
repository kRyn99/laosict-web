<?php
 ...
 return [
    ...
    "category_frontend_image" => "Frontend Image 489 x 397",
    "payment_amount" => "Giá trị quyên góp",
    "partner_image" => "Hình ảnh/Logo Đối Tác Đồng Hành (64x64)",
    ...
    "partner_desc" => "Mô tả Đối Tác Đồng Hành  14",
    ...
    "partner_total_collect_amount" => "Số tiền quyên góp được của Đối Tác Đồng Hành  18",
    ...
    "partner_name" => "Tên Đối Tác Đồng Hành 1",
    ...
    "partner" => "Đối Tác Đồng Hành 1",
    "program_partner_id" => "Đối tác đồng hành",
    "post_image" => "Ảnh bài viết (1128 x 542)",
    "project_image" => "Ảnh hoàn cảnh (1128x542)",
