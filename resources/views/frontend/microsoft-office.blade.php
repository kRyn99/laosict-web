...
@section('content')
    ...
    <div class="course-landing-page">
        ...
        <section class="relative">
            ...
            <div class="absolute w-20 h-20 rounded-full"style="background: #CE2029;right: 56%;bottom: 10%;z-index: 1;opacity:30%"></div>
            <div class="banner-microsoft-office relative">
                ...
                <div class="right">
                    <img class="relative z-1" src="/new-front-end/image/banner-microsoft-office.png" width="100%" height="100%">
                ...
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <table class="result-list">
                        <tr>
                            ...
                            <td class="ff-popins fs-18 fw-600 text-white">Draft, edit, and print text and documents with Word</td>
                        </tr>
                        <tr>
                            <td><img src="/new-front-end/image/computer.png"></td>
                            <td class="ff-popins fs-18 fw-600 text-white">Calculate and process data effectively with Excel</td>
                        </tr>
                        <tr>
                            <td><img src="/new-front-end/image/computer.png"></td>
                            <td class="ff-popins fs-18 fw-600 text-white">Design professional presentation slides with PowerPoint</td>
                        </tr>
                        <tr>
                            <td><img src="/new-front-end/image/computer.png"></td>
                            <td class="ff-popins fs-18 fw-600 text-white">Mastering skills with MS office brings efficiency to your current work.</td>
                        </tr>
